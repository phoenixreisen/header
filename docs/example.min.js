(function (m) {
    ...
    var Topbar = {
        ...
        view: function (_a) {
            ...
            var backUrl = attrs.backUrl, faviconUrl = attrs.faviconUrl, faviconTarget = attrs.faviconTarget;
                ...
                m__default['default']("div", { class: "wrapper wrapper--large" },
                    m__default['default']("div", { class: "top-bar__left" },
                        ...
                        m__default['default']("a", { href: faviconTarget || 'https://www.phoenixreisen.com', title: "zur Startseite" },
                            ...
                            m__default['default']("span", { class: "ml1" }, "Mein Phoenix"))),
                    toggleAvatar ?
                        m__default['default']("article", { class: "top-bar__avatar" },
                            m__default['default']("a", { href: "javascript:", class: "avatar-cta avatar-cta--topbar", title: "Buchungsdaten anzeigen", onclick: function () { return toggleAvatar(); } },
                                m__default['default']("i", { class: "fas fa-user avatar__symbol" })))
                        : '',
                    toggleNav ?
                        m__default['default']("a", { href: "javascript:", class: "nav-btn top-bar__nav-btn noprint", title: "Navigation ein-/ausblenden", onclick: function () { return toggleNav(); } },
                            m__default['default']("i", { class: "fas fa-bars" }))
                        : '')));
        }
    };
